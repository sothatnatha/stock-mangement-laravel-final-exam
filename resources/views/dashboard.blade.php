...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        {{-- <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{ asset('/img/loading.png') }}" alt="AdminLTELogo" height="60"
                width="60">
        </div> --}}
        ...
        <aside class="main-sidebar sidebar-dark-primary navbg elevation-4">
            <!-- Brand Logo -->
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('/logo/packages.png') }}" class="img-circle " alt="Logo Image">
                    </div>
                    <div class="info">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="/admin/article/trash" class="nav-link">
