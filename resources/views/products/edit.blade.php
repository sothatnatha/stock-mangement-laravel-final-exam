    ...
    <div class="container-fluid">
        ...
        <div class="card p-4">
            <form action="/products/{{ $product->id }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card p-4">
                    <label for="picture">Previous pricture</label>
                    <img src="/storage/{{ $product->picture }}" alt="" width="20%" height="50%">
                </div>
                ...
                <input type="submit" value="Update product" class="btn btn-warning mb-4 btn-sm" style="float: right">
